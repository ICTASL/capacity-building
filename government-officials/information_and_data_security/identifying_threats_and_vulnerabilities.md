...
Phishing attacks are a common tactic used by cybercriminals to trick individuals into revealing sensitive information or downloading malicious software. Phishing emails often mimic legitimate organizations and may contain urgent requests, threats, or enticing offers. 
...
Cybercriminals may attempt to gain unauthorized access to government systems through various methods, such as:
...
**Malware:**
Malware is malicious software designed to harm computer systems. Common types of malware include:
...
**Questions:**
1. What are the red flags in each scenario?
2. How should you respond to these situations?

**Answers:**
1. **Scenario 1:** The urgent request, unusual sender address, and lack of specific details are red flags.
2. **Scenario 2:** Unidentified USB drives can contain malicious software.
3. **Scenario 3:** The IT department would never ask for your password over the phone.
...
* **Federal Bureau of Investigation (FBI):** [https://www.fbi.gov/services](https://www.fbi.gov/services)

### Real-World Examples of Security Incidents
* **Have I Been Pwned:** [https://haveibeenpwned.com/](https://haveibeenpwned.com/)
* **CERT Coordination Center (CERT/CC):** [https://www.kb.cert.org/](https://www.kb.cert.org/)

### Recognizing Potential Threats
* **Phishing.org:** [https://www.phishing.org/](https://www.phishing.org/)
* **National Institute of Standards and Technology (NIST):** [https://www.nist.gov/](https://www.nist.gov/)

### Social Engineering
* **Social Engineering Toolkit (SET):** [https://github.com/trustedsec/social-engineer-toolkit](https://github.com/trustedsec/social-engineer-toolkit)
