...
* **Expected Initial Salary Ranges:** Entry-level salaries for Project Management roles can vary based on industry, location, and company size. In the US, starting salaries for entry-level Project Coordinators/Junior Project Managers can range from 19,152,250 LKR to 28,000,000 LKR + per year. Salaries can be higher in major metropolitan areas or for roles in high-demand industries like technology and finance. Earning certifications like CAPM or entry-level Agile certifications can positively influence starting salaries.
